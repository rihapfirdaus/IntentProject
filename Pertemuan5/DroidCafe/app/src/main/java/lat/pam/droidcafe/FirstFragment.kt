...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<ImageView>(R.id.donut).setOnClickListener(View.OnClickListener {
            displayToast(getResources().getString(R.string.donut_order_message))
        })
        view.findViewById<ImageView>(R.id.ice_cream).setOnClickListener(View.OnClickListener {
            displayToast(getResources().getString(R.string.ice_cream_order_message))
        })
        view.findViewById<ImageView>(R.id.froyo).setOnClickListener(View.OnClickListener {
